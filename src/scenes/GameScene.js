...
// お祈りメールの定型句から拾った語を並べてある（ご縁／お祈り／選考／残念）。
// 「選考」は2文字まとめて指定してあるので、「選」単体の指定と重なっても
// 二重に印は付かない（フラグを立てるだけなので何度当たっても同じ）。
// 「考」を爆弾にするのは「選考」と続いたときだけ、という違いがある
const BOMB_WORDS = ['選考', '縁', '祈', '選', '残'];
